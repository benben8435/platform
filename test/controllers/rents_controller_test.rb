...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { date_from: @rent.date_from, date_to: @rent.date_to, description: @rent.description, title: @rent.title }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { date_from: @rent.date_from, date_to: @rent.date_to, description: @rent.description, title: @rent.title }
    assert_redirected_to rent_path(assigns(:rent))
  end
